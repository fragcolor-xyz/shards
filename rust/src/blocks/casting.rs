...
lazy_static! {
  static ref LEB_PARAMETERS: Parameters = vec![(
    cstr!("Signed"),
    cbccstr!("If the integer to encode/decode is signed and can be negative."),
...
pub fn registerBlocks() {
  ...
  registerBlock::<ToLEB128>();
  registerBlock::<FromLEB128>();
}
