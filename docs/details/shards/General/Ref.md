The name of the variable comes from the `Name` parameter and the constant value comes from the input. The type of input controls the type of variable that will be created: numeric input creates numeric variable, string input creates string variable, and sequence input would create a sequence variable.
