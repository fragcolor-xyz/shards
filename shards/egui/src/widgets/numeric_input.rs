...
impl_ui_n_input!(
  ...
  Float2Input,
  "UI.Float2Input",
  "UI.Float2Input-rust-0x20250822",
  FLOAT2_VAR_SLICE,
  float2,
  float2_var,
  f64,
...
impl_ui_n_input!(
  ...
  Float3Input,
  "UI.Float3Input",
  "UI.Float3Input-rust-0x20250822",
  FLOAT3_VAR_SLICE,
  float3,
  float3_var,
  f32,
...
impl_ui_n_input!(
  ...
  Float4Input,
  "UI.Float4Input",
  "UI.Float4Input-rust-0x20250822",
  FLOAT4_VAR_SLICE,
  float4,
  float4_var,
  f32,
