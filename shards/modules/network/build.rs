...
fn generate_bindings() {
  ...
  // // let shards_header_path = format!("{}/shards/shards.h", shards_include_dir);
  // let main_header_path = format!("network_shared.h");

  // // Tell cargo to regenerate the bindings whenever the headers change
  // println!("cargo:rerun-if-changed={}", main_header_path);
  // // println!("cargo:rerun-if-changed={}", shards_header_path);
