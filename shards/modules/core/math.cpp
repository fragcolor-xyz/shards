...
SHARDS_REGISTER_FN(math) {
  ...
  REGISTER_SHARD_ALIAS("Add", "Math.Add", Add);
  REGISTER_SHARD("Math.Subtract", Subtract);
  REGISTER_SHARD_ALIAS("Sub", "Math.Subtract", Subtract);
  REGISTER_SHARD("Math.Multiply", Multiply);
  REGISTER_SHARD_ALIAS("Mul", "Math.Multiply", Multiply);
  REGISTER_SHARD("Math.Divide", Divide);
  REGISTER_SHARD_ALIAS("Div", "Math.Divide", Divide);
  ...
  REGISTER_SHARD_ALIAS("Abs", "Math.Abs", Abs);
  ...
  REGISTER_SHARD_ALIAS("Sqrt", "Math.Sqrt", Sqrt);
  REGISTER_SHARD("Math.FastSqrt", FastSqrt);
  REGISTER_SHARD_ALIAS("FastSqrt", "Math.FastSqrt", FastSqrt);
  REGISTER_SHARD("Math.FastInvSqrt", FastInvSqrt);
  REGISTER_SHARD_ALIAS("FastInvSqrt", "Math.FastInvSqrt", FastInvSqrt);
  REGISTER_SHARD("Math.Cbrt", Cbrt);
  REGISTER_SHARD("Math.Sin", Sin);
  REGISTER_SHARD_ALIAS("Sin", "Math.Sin", Sin);
  REGISTER_SHARD("Math.Cos", Cos);
  REGISTER_SHARD_ALIAS("Cos", "Math.Cos", Cos);
  REGISTER_SHARD("Math.Tan", Tan);
  REGISTER_SHARD_ALIAS("Tan", "Math.Tan", Tan);
  REGISTER_SHARD("Math.Asin", Asin);
  REGISTER_SHARD_ALIAS("Asin", "Math.Asin", Asin);
  ...
  REGISTER_SHARD_ALIAS("Pow", "Math.Pow", Pow);

  REGISTER_SHARD("Math.Lerp", Lerp);
  REGISTER_SHARD_ALIAS("Lerp", "Math.Lerp", Lerp);
