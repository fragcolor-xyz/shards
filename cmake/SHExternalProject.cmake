...
# Apple flags
if(APPLE)
  list(APPEND EXTERNAL_CMAKE_ARGS -DCMAKE_OSX_DEPLOYMENT_TARGET=${CMAKE_OSX_DEPLOYMENT_TARGET})
endif()
...
# Zig cross-compilation flags
if(ZIG_TARGET)
  list(APPEND EXTERNAL_CMAKE_ARGS -DZIG_TARGET=${ZIG_TARGET})
endif()
if(ZIG_LIB_DIR)
  list(APPEND EXTERNAL_CMAKE_ARGS -DZIG_LIB_DIR=${ZIG_LIB_DIR})
endif()
if(ZIG_ARCH)
  list(APPEND EXTERNAL_CMAKE_ARGS -DZIG_ARCH=${ZIG_ARCH})
endif()
if(ZIG_MUSL)
  list(APPEND EXTERNAL_CMAKE_ARGS -DZIG_MUSL=${ZIG_MUSL})
endif()
if(ZIG_WRAPPER_DIR)
  list(APPEND EXTERNAL_CMAKE_ARGS -DZIG_WRAPPER_DIR=${ZIG_WRAPPER_DIR})
endif()

if(CMAKE_OSX_ARCHITECTURES)
  list(APPEND EXTERNAL_CMAKE_ARGS -DCMAKE_OSX_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES})
endif()
