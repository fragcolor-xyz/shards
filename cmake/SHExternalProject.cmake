...
if(EMSCRIPTEN)
  if(EMSCRIPTEN_PTHREADS)
    list(APPEND EXTERNAL_CMAKE_CXX_FLAGS -sUSE_PTHREADS=1)
    list(APPEND EXTERNAL_CMAKE_C_FLAGS -sUSE_PTHREADS=1)
  endif()
endif()

# if(EXTERNAL_CMAKE_CXX_FLAGS)
#   list(APPEND EXTERNAL_CMAKE_ARGS "\"-DCMAKE_CXX_FLAGS=${EXTERNAL_CMAKE_CXX_FLAGS}\"")
# endif()
# if(EXTERNAL_CMAKE_C_FLAGS)
#   list(APPEND EXTERNAL_CMAKE_ARGS "\"-DCMAKE_C_FLAGS=${EXTERNAL_CMAKE_C_FLAGS}\"")
# endif()
...
function(sh_add_external_project)
  ...
  # string(REPLACE " " ";" _EXTERNAL_CMAKE_CXX_FLAGS "${EXTERNAL_CMAKE_CXX_FLAGS}")
  # string(REPLACE " " ";" _EXTERNAL_CMAKE_C_FLAGS "${EXTERNAL_CMAKE_C_FLAGS}")
  list(JOIN EXTERNAL_CMAKE_CXX_FLAGS " " _EXTERNAL_CMAKE_CXX_FLAGS)
  list(JOIN EXTERNAL_CMAKE_C_FLAGS " " _EXTERNAL_CMAKE_C_FLAGS)
  message(STATUS "_EXTERNAL_CMAKE_CXX_FLAGS=${_EXTERNAL_CMAKE_CXX_FLAGS}")
  message(STATUS "_EXTERNAL_CMAKE_C_FLAGS=${_EXTERNAL_CMAKE_C_FLAGS}")
  ...
  ExternalProject_Add(${PROJ_NAME}
    ...
    ${EXTPROJ_ARGS}
    INSTALL_COMMAND ""
    CMAKE_ARGS -DCMAKE_BUILD_TYPE=${EXTERNAL_BUILD_TYPE} "-DCMAKE_INSTALL_PREFIX:PATH=${PROJ_INSTALL_PATH}"
      # "-DCMAKE_CXX_FLAGS="
      # "-DCMAKE_C_FLAGS=${_EXTERNAL_CMAKE_C_FLAGS}"
      ${EXTERNAL_CMAKE_ARGS}
      ${PROJ_CMAKE_ARGS}
    # CMAKE_CACHE_ARGS_DEFAULT 
    #   "-DCMAKE_CXX_FLAGS:STRING=${_EXTERNAL_CMAKE_CXX_FLAGS}"
    #   "-DCMAKE_C_FLAGS:STRING=${_EXTERNAL_CMAKE_C_FLAGS}"
