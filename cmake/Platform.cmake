...
if(APPLE)
  ...
  if(IOS)
    if(APPLE_DEPLOYMENT_TARGET)
      set(CMAKE_OSX_DEPLOYMENT_TARGET "${APPLE_DEPLOYMENT_TARGET}" CACHE STRING "Minimum iOS deployment version" FORCE)
    else()
  ...
  elseif(VISIONOS)
    if(APPLE_DEPLOYMENT_TARGET)
      set(CMAKE_OSX_DEPLOYMENT_TARGET "${APPLE_DEPLOYMENT_TARGET}" CACHE STRING "Minimum visionOS deployment version" FORCE)
    else()
 ...
 elseif(WATCHOS)
  ...
  if(XCODE_SDK)
    ...
    if(IS_SIMULATOR)
      ...
      elseif(XCODE_SDK MATCHES "xrsimulator")
...
if(EMSCRIPTEN)
  ...
  if(CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo" OR CMAKE_BUILD_TYPE STREQUAL "Debug")
    ...
    # Strip -g from flags - Emscripten's wasm-emscripten-finalize chokes on DWARF
    # Use source maps instead for debugging
