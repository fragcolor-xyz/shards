...
if(MSVC OR CMAKE_CXX_SIMULATE_ID MATCHES "MSVC")
  ...
  if(USE_ASAN)
    ...
    list(APPEND EXTERNAL_CMAKE_ARGS -DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded)
  ...
  if(CMAKE_BUILD_TYPE MATCHES "Debug")
    ...
    list(APPEND EXTERNAL_CMAKE_CXX_FLAGS -D_ITERATOR_DEBUG_LEVEL=${ITERATOR_DEBUG_LEVEL})
  endif()
else()
  set(WINDOWS_ABI "gnu")
endif()
...
if(CMAKE_BUILD_TYPE STREQUAL "Release" OR CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo")
  ...
  if(WIN32)
    ...
    list(APPEND EXTERNAL_CMAKE_CXX_FLAGS -static)
    list(APPEND EXTERNAL_CMAKE_C_FLAGS -static)
  endif()
