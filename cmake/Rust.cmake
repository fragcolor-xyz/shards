...
function(add_rust_library)
  ...
  set(BIN_LIB_PATH ${CMAKE_CURRENT_BINARY_DIR}/${GENERATED_LIB_NAME})

  if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
    file(TO_NATIVE_PATH "${GENERATED_LIB_PATH}" GENERATED_LIB_PATH_NATIVE)
    file(TO_NATIVE_PATH "${BIN_LIB_PATH}" BIN_LIB_PATH_NATIVE)
    set(MOVE_COMMAND move /Y "${GENERATED_LIB_PATH_NATIVE}" "${BIN_LIB_PATH_NATIVE}")
  else()
    set(MOVE_COMMAND mv ${GENERATED_LIB_PATH} ${BIN_LIB_PATH})
  endif()

  make_directory(${CMAKE_CURRENT_BINARY_DIR})
  add_custom_command(
    OUTPUT ${BIN_LIB_PATH} ${RUST_OUTPUTS}
  ...
  set_target_properties(${RUST_TARGET_NAME} PROPERTIES
    IMPORTED_LOCATION ${BIN_LIB_PATH}
  )
