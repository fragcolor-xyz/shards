$input a_position, a_normal, a_tangent, a_texcoord0, a_texcoord1, a_color0, i_data0, i_data1, i_data2, i_data3 $output v_normal,
    v_tangent, v_bitangent, v_texcoord0, v_texcoord1, v_color0, v_wpos,
    v_view
...
#include <shaderlib.h>
        ...
        mat3
        mtx3FromCols(vec3 c0, vec3 c1, vec3 c2) {
