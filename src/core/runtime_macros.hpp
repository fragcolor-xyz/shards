...
{\
  ...
  case Float3:\
    ...
    __output.payload.float3Value[0] = __cfuncf(__input.payload.float3Value[0]);\
    __output.payload.float3Value[1] = __cfuncf(__input.payload.float3Value[1]);\
    __output.payload.float3Value[2] = __cfuncf(__input.payload.float3Value[2]);\
    break;\
  case Float4:\
    __output.valueType = Float4;\
    __output.payload.float4Value[0] = __cfuncf(__input.payload.float4Value[0]);\
    __output.payload.float4Value[1] = __cfuncf(__input.payload.float4Value[1]);\
    __output.payload.float4Value[2] = __cfuncf(__input.payload.float4Value[2]);\
    __output.payload.float4Value[3] = __cfuncf(__input.payload.float4Value[3]);\
    break;\
  default:\
...
{\
  ...
  {\
    CBVar tmp;\
    _runChainINLINECMATH(__cfunc, __cfuncf, __cfunc_str, input.payload.seqValue[i], tmp)\
...
auto operand = cblock->operand.valueType == ContextVar ?\
  cblock->ctxOperand ? *cblock->ctxOperand : *(cblock->ctxOperand = contextVariable(context, cblock->operand.payload.stringValue)) :\
    cblock->operand;\
...
{\
  ...
  {\
    case Int:\
      ...
      __output.payload.intValue = __input.payload.intValue __op operand.payload.intValue;\
      break;\
    case Int2:\
      __output.valueType = Int2;\
      __output.payload.int2Value = __input.payload.int2Value __op operand.payload.int2Value;\
      break;\
    case Int3:\
      __output.valueType = Int3;\
      __output.payload.int3Value = __input.payload.int3Value __op operand.payload.int3Value;\
      break;\
    case Int4:\
    ...
    case Float2:\
      __output.valueType = Float2;\
      __output.payload.float2Value = __input.payload.float2Value __op operand.payload.float2Value;\
      break;\
    case Float3:\
      __output.valueType = Float3;\
      __output.payload.float3Value = __input.payload.float3Value __op operand.payload.float3Value;\
      break;\
    case Float4:\
      __output.valueType = Float4;\
      __output.payload.float4Value = __input.payload.float4Value __op operand.payload.float4Value;\
      break;\
    case Color:\
      __output.valueType = Color;\
      __output.payload.colorValue.r = __input.payload.colorValue.r __op operand.payload.colorValue.r;\
      __output.payload.colorValue.g = __input.payload.colorValue.g __op operand.payload.colorValue.g;\
      __output.payload.colorValue.b = __input.payload.colorValue.b __op operand.payload.colorValue.b;\
      __output.payload.colorValue.a = __input.payload.colorValue.a __op operand.payload.colorValue.a;\
      break;\
    default:\
...
{\
  ...
  {\
    CBVar tmp;\
    __runChainINLINE_INT_MATH(__op, __op_str, input.payload.seqValue[i], tmp)\
    stbds_arrpush(cblock->seqCache, tmp);\
  }\
  previousOutput.valueType = Seq;\
  previousOutput.payload.seqValue = cblock->seqCache;\
