...
namespace mal {
malValuePtr atom(malValuePtr value) { return malValuePtr(new malAtom(value)); };
...
malHash::malHash(malValueIter argsBegin, malValueIter argsEnd, bool isEvaluated)
    : m_map(createMap(argsBegin, argsEnd)), m_isEvaluated(isEvaluated) {}
...
malLambda::malLambda(const StringVec &bindings, malValuePtr body, malEnvPtr env)
...
malValuePtr malList::conj(malValueIter argsBegin, malValueIter argsEnd) const {
