...
public:
  ...
  void setupWindowInput(Window &window, float scalingFactor = 1.0f);
  ...
  const egui::Input *translateFromInputEvents(const std::vector<SDL_Event> &events, Window &window, double time, float deltaTime,
