...
void EguiInputTranslator::setupWindowInput(Window &window, float scalingFactor) {
...
const egui::Input *EguiInputTranslator::translateFromInputEvents(const std::vector<SDL_Event> &events, Window &window,
                                                                 double time, float deltaTime, float scalingFactor) {
  setupWindowInput(window, scalingFactor);
