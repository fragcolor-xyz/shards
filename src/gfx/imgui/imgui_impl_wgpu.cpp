...
void ImGui_ImplWGPU_RenderDrawData(ImDrawData *draw_data, WGPURenderPassEncoder pass_encoder) {
  ...
  if (fr->VertexBuffer == NULL || fr->VertexBufferSize < draw_data->TotalVtxCount) {
    ...
    WGPUBufferDescriptor vb_desc = {NULL, "Dear ImGui Vertex buffer", WGPUBufferUsage_CopyDst | WGPUBufferUsage_Vertex,
  ...
  if (fr->IndexBuffer == NULL || fr->IndexBufferSize < draw_data->TotalIdxCount) {
    ...
    WGPUBufferDescriptor ib_desc = {NULL, "Dear ImGui Index buffer", WGPUBufferUsage_CopyDst | WGPUBufferUsage_Index,
      ...
      if (pcmd->UserCallback != NULL) {
        ...
        if (bind_group) {
          ...
          WGPUBindGroup image_bind_group =
              ImGui_ImplWGPU_CreateImageBindGroup(g_resources.ImageBindGroupLayout, (WGPUTextureView)tex_id);
...
static void ImGui_ImplWGPU_CreateUniformBuffer() {
  WGPUBufferDescriptor ub_desc = {NULL, "Dear ImGui Uniform buffer", WGPUBufferUsage_CopyDst | WGPUBufferUsage_Uniform,
                                  sizeof(Uniforms), false};
